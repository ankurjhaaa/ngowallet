...
function AccountDeletionContent() {
 ...
 <div className="max-w-5xl mx-auto px-4">
 <div className="bg-white border border-gray-100 rounded-md p-3 md:p-4">
 <ol className="space-y-5 text-gray-700">
 <li className="flex gap-3">
 <span className="h-7 w-7 shrink-0 rounded-md bg-rose-100 text-rose-700 text-xs font-semibold flex items-center justify-center">1</span>
 <div>
 ...
 <li className="flex gap-3">
 <span className="h-7 w-7 shrink-0 rounded-md bg-rose-100 text-rose-700 text-xs font-semibold flex items-center justify-center">2</span>
 <div>
 ...
 <li className="flex gap-3">
 <span className="h-7 w-7 shrink-0 rounded-md bg-rose-100 text-rose-700 text-xs font-semibold flex items-center justify-center">3</span>
 <div>
 ...
 <li className="flex gap-3">
 <span className="h-7 w-7 shrink-0 rounded-md bg-rose-100 text-rose-700 text-xs font-semibold flex items-center justify-center">4</span>
 <div>
 ...
 <div className="mt-5 p-4 rounded-md bg-amber-50 border border-amber-100 text-amber-800 text-sm">
 {t.deletionNote}
 </div>
 </div>
 </div>
