...
function JoinContent() {
 ...
 {/* HERO */}
 <section className="bg-emerald-50 to-white pt-16 pb-12">
 ...
 <a href="/contact"className="bg-emerald-800 text-white px-4 py-3 rounded-md hover:bg-emerald-700 transition font-medium text-sm">
 <i className="fas fa-envelope mr-2"></i>{t.joinCtaBtn1}
 </a>
 <a href="tel:+919000000000"className="border border-emerald-800 text-emerald-800 px-4 py-3 rounded-md hover:bg-emerald-50 transition font-medium text-sm">
