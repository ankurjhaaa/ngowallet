...
export default function Plans() {
 ...
 <tr>
 <th className="px-4 py-4 text-[10px] font-bold uppercase tracking-widest">Plan Details</th>
 <th className="px-4 py-4 text-[10px] font-bold uppercase tracking-widest text-center">Commitment (₹)</th>
 <th className="px-4 py-4 text-[10px] font-bold uppercase tracking-widest text-center">Duration</th>
 <th className="px-4 py-4 text-[10px] font-bold uppercase tracking-widest text-right">Actions</th>
 </tr>
 </thead>
 ...
 <div className="w-12 h-12 bg-gray-50 rounded-md flex items-center justify-center text-gray-300 mb-3">
 ...
 <div className="w-8 h-8 rounded-md bg-red-50 text-red-800 flex items-center justify-center text-xs">
 ...
 <td className="px-4 py-4 text-center">
 <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-100 rounded-md text-[10px] font-bold text-gray-600">
 ...
 className="h-8 w-8 rounded-md bg-white border border-gray-100 flex items-center justify-center text-red-800 hover:bg-red-800 hover:text-white transition"
 title="Edit Plan"
 >
 ...
 {plans.length === 0 ? (
 <div className="bg-white rounded-md p-12 border border-dashed border-gray-200 text-center">
 ...
 <div
 key={plan.id}
 className="bg-white rounded-md border border-gray-100 p-4 relative overflow-hidden group active:bg-red-50/50 transition"
 >
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-md bg-red-100 text-red-800 flex items-center justify-center">
 ...
 <button
 onClick={() => openEdit(plan)}
 className="h-8 px-3 rounded-md bg-gray-50 text-red-800 text-[10px] font-bold hover:bg-red-100 transition flex items-center gap-1.5"
 >
...
function PlanForm({ plan, onClose }) {
 ...
 <div className="bg-white w-full max-w-md rounded-md p-4 relative z-10 animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
 ...
 <button onClick={onClose} className="w-8 h-8 rounded-md bg-gray-50 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-900 transition">
 ...
 className="w-full h-11 rounded-md bg-gray-50 border border-gray-100 px-4 text-xs font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-red-100 focus:border-red-800 transition"
 />
 ...
 placeholder="0.00"
 className="w-full h-11 rounded-md bg-gray-50 border border-gray-100 px-4 text-xs font-black text-gray-900 focus:bg-white focus:ring-2 focus:ring-red-100 focus:border-red-800 transition"
 />
 ...
 className="w-full h-11 rounded-md bg-gray-50 border border-gray-100 px-4 text-xs font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-red-100 focus:border-red-800 transition pr-12"
 />
 ...
 type="button"
 onClick={onClose}
 className="flex-1 h-11 rounded-md bg-gray-50 text-xs font-bold text-gray-500 hover:bg-gray-100 transition"
 >
 Cancel
 </button>
 <button
 type="submit"
 disabled={processing}
 className="flex-2 h-11 px-4 rounded-md bg-red-800 text-white text-xs font-extrabold hover:bg-red-900 transition disabled:opacity-60"
 >
