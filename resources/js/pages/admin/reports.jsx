            ...
            <div className="mb-6">
                <div className="sm:hidden flex items-center justify-between mb-3">
                    ...
                    <button
                        ...
                        className="h-9 px-4 rounded-full bg-red-800 text-white text-xs font-semibold cursor-pointer"
                    >
                ...
                <form
                    ...
                    className={`bg-white rounded-2xl shadow-sm p-4 sm:p-5 ${showFilters ? "block" : "hidden sm:block"}`}
                >
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row gap-3">
                        <button
                            type="submit"
                            className="h-11 px-5 rounded-xl bg-red-800 text-white text-sm font-semibold hover:bg-red-900 cursor-pointer"
                        >
                            Apply Filters
                        </button>
                        <button
                            ...
                            className="h-11 px-5 rounded-xl border border-gray-200 text-sm text-gray-600 hover:bg-gray-50 cursor-pointer"
                        >
                            Reset
                        </button>
                    </div>
